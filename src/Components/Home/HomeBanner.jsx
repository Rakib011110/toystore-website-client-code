        ...
        <div className="flex  mx-auto flex-col md:flex-row bg-gray-100">
          <div className="md:w-1/2">
            <a href="#" className="group relative block bg-black">
              <img
                alt="Developer"
                src="https://img.freepik.com/premium-photo/closeup-photo-beautiful-little-lady-holding-arms-cheekbones-exciting-mood-newyear-discounts-wear-jeans-overall-white-t-shirt-isolated-red-vivid-color-background_274222-17784.jpg"
            ...
            <div className="text-center">
              <div>
                <Player
                  ...
                  autoplay
                  loop
                  src="https://assets6.lottiefiles.com/packages/lf20_qcdojejs.json"
                  // style={{ height: "500px", width: "700px" }}
                ></Player>
              </div>
              <h2 className="text-4xl font-bold mb-4  text-blue-600">
                WELCOME TO OUR TOYS WEBSITE
              </h2>
              <p className="text-xl mb-4">
                BABY TOYS is any nutrient-rich material consumed or absorbed by
                humans, animals, or plants in order to sustain life and growth.
                The major sources ofBABY TOYS are animals and plants. It is
                consumed because it
              </p>
              <a
                href="#"
