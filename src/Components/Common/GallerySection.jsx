  ...
  return (
    <div>
      <section className="mx-auto w-fit p-12 mt-20 ">
        <h1 className="font-serif font-extrabold text-2xl text-indigo-700   mt-5 mb-3">
          {" "}
          <span className="text-red-500"> CLIENTS</span> RIVIEW{" "}
        </h1>
        <p className=" font-thin    mb-10">
          Most professional services use the term <br /> clients whereas most
          product sellers use the term customers
        </p>
